...
### Added
- Streamlit dashboard (`dashboard/app.py`) with interactive filters, attendance heatmaps, and trend charts
...
### Added
- `scripts/convert_to_parquet.py` for batch CSV → Parquet conversion
- `scripts/assemble_dataset.py` updated to assemble Parquet batches + optional sample creation
