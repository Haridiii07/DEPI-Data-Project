...
- **Status:** ✅ Complete
- **Primary file:** `scripts/Milestone2_3_SQL_and_Visualizations.ipynb`
- **Database:** `scripts/student_performance.duckdb`
- **Input:** `data/milestone1_real/cleaned_students.parquet`
...
SELECT DISTINCT
  ...
  student_id,
  student_name
FROM parquet_scan('data/milestone1_real/cleaned_students.parquet');
```
...
- For PowerShell paths, use quotes: `"scripts\Milestone2_3_SQL_and_Visualizations.ipynb"`
