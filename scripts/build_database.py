...
def build_database():
    ...
    data_path = base_dir / 'data' / 'milestone1_real' / 'cleaned_students.parquet'
    db_path = base_dir / 'scripts' / 'student_performance.duckdb'
    ...
    try:
        ...
        conn.execute("""
            ...
            SELECT 
                ...
                CAST(university_type AS VARCHAR) AS university_type,
        ...
        conn.execute("""
            ...
            FROM (
                SELECT DISTINCT university, state, university_type, ipeds_institutional_factor
                FROM staging_student_performance
